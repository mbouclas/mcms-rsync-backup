...
var Config = {
    ...
    defaultDestination : '/temp',
    numberOfBackups : 2,//set to 0 to NOT create tarballs
    archiveLocation : '/temp/archives',
    recursive : false,
    logsDir : '/temp/backupLogs'
};
...
function runRsync(item,cb){
    ...
    var command = 'rsync -avurvt --progress --delete ' + item.folder + ' ' + item.destFolder;
